...
// ─── STRESS CONFIG ────────────────────────────────────────────────────────────
const NUM_DYNAMIC   = 2000;   // 'always'-moving objects
const NUM_STATIC    = 200;   // 'never'-moving objects (rebuilt once)
const NUM_ONSCREEN  = 0;   // 'onscreen'-only movers
const PARTS_PER_OBJ = 10;     // parts per dynamic object (1 root + extras)
const MAP_SIZE      = 80000;  // world half-extent
const BOUNCE_BOUNDS = 80000;  // objects bounce inside this radius
const PARTICLES_PER_FRAME  = 400;   // background particles added each frame
const RADIALS_PER_FRAME    = 45;    // radial rings added each frame
const LINES_PER_FRAME      = 78;    // line effects added each frame
