...
Main.creatorsFunction = function (){
  ...
  redArrow.rotation -=1;
  Main.tickMsg.push ({"text":'Green: '+greenArrow.rotation, "indent":0});
  Main.tickMsg.push ({"text":'Blue: '+greenArrow.rotation, "indent":0});
  Main.tickMsg.push ({"text":'Red: '+redArrow.rotation, "indent":0});
}
Main.run(10);
