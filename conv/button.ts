...
export class Button {
  guiElement: GUIElement | undefined = undefined;
  simObject: SimObject | undefined = undefined;
  value: unknown;
  clicked: boolean = false;
  clickFn: ((data: EventData) => void) | undefined = undefined;
  ...
  constructor(
    value: unknown,
    toggle: boolean = false,
    objectOrElement: SimObject | GUIElement,
    clickFn?: (data: EventData) => void
  ) {
  ...
  #doButton(insideBounds: boolean): boolean {
