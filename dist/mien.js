...
export class Mien {
    ...
    #get(mood) {
        ...
        if (this.#moods.has(mood)) {
            ...
            if (moodAppearance.bgColor)
                appearance.bgColor = moodAppearance.bgColor;
            if (moodAppearance.borderColor)
                appearance.borderColor = moodAppearance.borderColor;
            if (moodAppearance.textColor)
                appearance.textColor = moodAppearance.textColor;
            if (moodAppearance.fontName)
                appearance.fontName = moodAppearance.fontName;
            if (moodAppearance.fontSize)
                appearance.fontSize = moodAppearance.fontSize;
            if (moodAppearance.borderWidth)
                appearance.borderWidth = moodAppearance.borderWidth;
